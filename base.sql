...
INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Perroquet Ara', 'Ara macao', 1.0, 'exotique', @idSpectacle2);
INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Cacatoès', 'Cacatua galerita', 0.9, 'exotique', @idSpectacle2);
INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Toucan', 'Ramphastos toco', 1.1, 'exotique', @idSpectacle2);

INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Cygne Tuberculé', 'Cygnus olor', 1.5, 'aquatique', @idSpectacle3);
INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Canard Mandarin', 'Aix galericulata', 0.5, 'aquatique', @idSpectacle3);
INSERT INTO Oiseau (nom, espece, taille, typeO, idSpectacle) VALUES('Héron Cendré', 'Ardea cinerea', 1.2, 'aquatique', @idSpectacle3);
